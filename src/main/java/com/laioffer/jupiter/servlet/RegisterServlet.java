...
public class RegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //json string to java obj
        //ObjectMapper mapper = new ObjectMapper();
        //request.getReader() -> requestbody
        //user.class -> reflection
        ...
        try { //try(MySQL Connection = new MySQLConnection()), try-this.
        ...
        } catch (MySQLException e) { //runtime exception, cannot find during compile time
