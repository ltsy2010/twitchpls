...
public class MySQLTableCreator { //initialize table
    ...
    public static void main(String[] args) {
        try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver").newInstance();//for broken java implementation
            ...
            sql = "CREATE TABLE favorite_records ("
                    + "user_id VARCHAR(255) NOT NULL," //one byte records the length, total 256 char[] array = new array[255]
