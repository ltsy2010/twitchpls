...
public class TwitchClient {
    private static final String TOKEN = "Bearer tdmbflk3fm9hcyvuo1s4s3m2wih4is"; //replace with token
    private static final String CLIENT_ID = "c61fm4n7vh0vqm158hesvz775n85yl"; //replace with client_Id
    ...
    private static final String TWITCH_BASE_URL = "https://www.twitch.tv/"; //corner case
    ...
    private String buildSearchURL(String url, String gameId, int limit) {
        ...
        return String.format(url, gameId, limit);//add gameID and limit to url template.
    }
    ...
    private List<Game> getGameList(String data) throws TwitchException {
        ...
        try {
            ...
            //Game[]: array, class: reflection. game class -> array object
    ...
    private List<Item> getItemList(String data) throws TwitchException {
        ObjectMapper mapper = new ObjectMapper();
        try {
            //convert json string(data) to item array
            //data is an array
    ...
    public List<Item> searchByType(String gameId, ItemType type, int limit) {
        List<Item> items = Collections.emptyList(); //or null
        switch(type) {
            case CLIP:
    ...
    //string ->itemtype including stream, clip, video ->key
    //or you can add this method to gameservlet
